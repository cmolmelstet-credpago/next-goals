...
import { useWindowSize } from '@modules/presentation/hooks/implementations/window-size';
import { Goals } from '@modules/domain/models';
import {
  Flex, GridItem,
} from '@chakra-ui/layout';
import { Grid as GridLayout } from '@chakra-ui/react';
import Card from '@modules/presentation/components/card';
            ...
            actionButton={(
              ...
              >
                <IconButton
                  ...
                  _active={{ bgGradient: 'linear(to-r, red.400, yellow.400)' }}
                  aria-label="Add Goal"
                  height="3rem"
                  width="3rem"
                  borderRadius="1.5rem"
