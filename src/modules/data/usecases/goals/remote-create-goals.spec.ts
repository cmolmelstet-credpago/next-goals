...
import { GoalsParams } from '@modules/domain/usecases';
import { HttpPostClientSpy } from '@modules/data/mocks';
import {
  mockGoalsParams, mockGoalsModel,
} from '@modules/domain/mocks';
import { HttpStatusCode } from '@modules/data/implementations/http/http-response';
import {
  InternalServerError, InvalidCredentials,
